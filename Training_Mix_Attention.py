...
class SincConv(Layer):
    ...
    def call(self, x, **kwargs):
        ...
        return out
#CBAM layer instead of Squeeze excitation     
class CBAM(Layer):
...
history = classifier.fit(x=[train_data, train_features,seen_imagine_flag],y=train_label, epochs=Epoch, batch_size=batch_size,
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('Training Mix Attention')
plt.show()
